namespace PSI.Data
{
    ...
    public interface IDbSession
    {
        ...
        /// <param name="entity">删除的实体</param>
        /// <returns>被删除的实体</returns>
        Task<TEntity> RemoveAsync<TEntity>(TEntity entity, CancellationToken cancellationToken = default(CancellationToken)) where TEntity : class;
        ...
        /// <param name="entity">更新的实体</param>
        /// <returns>更新后的实体</returns>
        Task<TEntity> UpdateAsync<TEntity>(TEntity entity, CancellationToken cancellationToken = default(CancellationToken)) where TEntity : class;
        ...
        /// <param name="key">实体主键</param>
        /// <returns>查找到的实体</returns>
        Task<TEntity> FindAsync<TEntity>(object key, CancellationToken cancellationToken = default(CancellationToken)) where TEntity : class;
        ...
        Task<TEntity> AttachAsync<TEntity>(TEntity entity, CancellationToken cancellationToken = default(CancellationToken)) where TEntity : class;
    }
}